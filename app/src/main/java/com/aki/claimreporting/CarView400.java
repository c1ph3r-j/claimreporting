...
public class CarView400 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_car_view400);
    ...
    public void init() {
        try {
            backid = (TextView) findViewById(R.id.carbackid);
            backid.setText("<< BACK");
            backid.setOnClickListener(onBackClicked -> onBackPressed());
...
//                    }
//                    mydb = new DatabaseHelper(CarView400.this);
//                    if(mydb.getlocalimageattachment().getCount() != 0)
//                    {
//                        Intent car = new Intent(CarView400.this, ReviewOwnImages.class);
//                        startActivity(car);
//                    }
//                    else
//                    {
//                        Toast.makeText(CarView400.this, getString(R.string.carproceed), Toast.LENGTH_SHORT).show();
//                        return;
//
//                    }
...
//                    else
//                    {
//                        Intent car = new Intent(CarView400.this, ProgressDialogUpload.class);
//                        startActivity(car);
//                    }
                        if (MainActivity.damagecountnew == 0) {
                            Toast.makeText(CarView400.this, getString(R.string.carproceed), Toast.LENGTH_SHORT).show();
                            ...
                            if (mydb.getlocalimageattachment().getCount() == MainActivity.damagecountnew) {
                                ...
                                if (incidenttypeval == "F82589E6-7344-47B2-A672-11013F538551") {
                                    startActivity(new Intent(CarView400.this, ClaimVisualArtifacts.class));
                                    finish();
                                } else {
                                    Intent car = new Intent(CarView400.this, ClaimVisualArtifacts.class);
                                    startActivity(car);
                                    finish();
                                }
                            } else {
...
//                    cirlcestate1=R.drawable.carnoselected_1;
                    ...
                    Intent intent = new Intent(CarView400.this, CameraDamage.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            ...
            supporteditor.putString(MainActivity.ReferrenceURL, "Car View 4 Image Capture");
            ...
            Intent login = new Intent(CarView400.this, SupportTicket.class);
            startActivity(login);
            return true;
...
//                    Intent login = new Intent(CarView400.this, EmergencyInformation.class);
//                    startActivity(login);
                } else {
