                ...
                public void onClick(View view) {
                    ...
                    if (isNetworkConnected()) {
                        ...
                        if (MainActivity.damagecountnew == 0) {
                            Toast.makeText(CarView.this, getString(R.string.carproceed), Toast.LENGTH_SHORT).show();
                            return;
                            ...
                            if (mydb.getlocalimageattachment().getCount() == MainActivity.damagecountnew) {
                                ...
                                if (incidenttypeval == "F82589E6-7344-47B2-A672-11013F538551") {
                                    startActivity(new Intent(CarView.this, ClaimVisualArtifacts.class));
                                    finish();
                                } else {
                                    Intent car = new Intent(CarView.this, ClaimVisualArtifacts.class);
                                    startActivity(car);
                                    finish();
                                }
                            } else {
                                Intent car = new Intent(CarView.this, ProgressDialogUpload.class);
                                startActivity(car);
                            }
                        }
                    } else {
...
//                    cirlcestate1=R.drawable.carnoselected_1;
                    ...
                    Intent intent = new Intent(CarView.this, CameraDamage.class);
            ...
            circle2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    SharedPreferences loadmodelPref = getSharedPreferences("LoadModelView", Context.MODE_PRIVATE);
                    SharedPreferences.Editor editor1 = loadmodelPref.edit();
                    // editor1.putString(AddVehicle.ModelID, "2");
                    editor1.putString(MainActivity.ModelID, "2");
                    editor1.apply();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_name) {
            ...
            supporteditor.putString(MainActivity.ReferrenceURL, "Car View Image Capture");
            supporteditor.apply();
            ...
            Intent login = new Intent(CarView.this, SupportTicket.class);
            startActivity(login);
            return true;
...
//                    Intent login = new Intent(CarView.this, EmergencyInformation.class);
//                    startActivity(login);
                } else {
