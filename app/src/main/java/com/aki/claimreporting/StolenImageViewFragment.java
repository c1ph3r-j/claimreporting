...
public class StolenImageViewFragment extends Fragment {

    AttachmentStolenimageList responsenew;

    public StolenImageViewFragment() {
        // Required empty public constructor
    }

    public StolenImageViewFragment(AttachmentStolenimageList response) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_stolen_image_view, container, false);

        ImageView imageView = view.findViewById(R.id.stolenImageViewForViewPager);
