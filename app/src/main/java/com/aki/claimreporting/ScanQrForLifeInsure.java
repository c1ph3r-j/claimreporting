...
public class ScanQrForLifeInsure extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scan_qr_for_life_insure);
    ...
    private void initialiseDetectorsAndSources() {
        ...
        try {
            ...
            BarcodeDetector barcodeDetector = new BarcodeDetector.Builder(ScanQrForLifeInsure.this)
                    .setBarcodeFormats(Barcode.ALL_FORMATS)
                    .build();

            cameraSource = new CameraSource.Builder(ScanQrForLifeInsure.this, barcodeDetector)
            ...
            surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
                ...
                public void surfaceCreated(SurfaceHolder holder) {
                    try {
                        if (ActivityCompat.checkSelfPermission(ScanQrForLifeInsure.this, Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                            cameraSource.start(surfaceView.getHolder());
                        } else {
                            ActivityCompat.requestPermissions(ScanQrForLifeInsure.this, new
                    ...
                    try {
                        if (barcodes.size() != 0) {
                            if (!isForwarded) {
                                ...
                                startActivity(new Intent(ScanQrForLifeInsure.this, GetLifeInsureDetails.class));
                                finish();
                            }
                        }
                    } catch (Exception e) {
